...
$disclosures = get_field('disclosures_link', 'options');
    ...
    <div role="none" id="app" class="relative z-1" x-cloak x-data="{ 
        ...
        <header class="h relative" :class="{ 'has:menu' : menu }">
            ...
            <div class="container flex justify-between items-center py-20 lg:pt-36 lg:pb-72">
                ...
                <button @click="toggleMenu()" class="h_menu-toggle lg:hidden flex flex-col justify-between items-center"
                    :class="menu ? 'is-active' : ''" aria-label="Show/Hide Menu" title="Show/Hide Menu">
                    <span></span>
                </button>
